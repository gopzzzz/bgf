								...
								<div class="w-100 d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
									...
									<div class="d-flex align-items-center flex-wrap mr-1">
										...
										<div class="d-flex align-items-baseline flex-wrap mr-5">
											<!--begin::Page Title-->
											<h5 class="text-dark font-weight-bold my-1 mr-5">HSN Creation</h5>
											<!--end::Page Title-->
											<!--begin::Breadcrumb-->
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                   <form method="POST" action="{{url('createhsn')}}" enctype="multipart/form-data" name="crmedit">
            ...
            <div class="form-group">
                                                     ...
                                                     <div class="form-group">
														<label>TAX %
														<span class="text-danger">*</span></label>
														<input type="text" class="form-control" name="tax" placeholder="Enter Tax " required />
                                                     ...
                                                     <div class="form-group">
														<label>IGST
														<span class="text-danger">*</span></label>
														<input type="text" class="form-control" name="igst" placeholder="Enter IGST" required />
