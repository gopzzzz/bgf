    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
			...
			<div class="form-group">
														<label>material_id
														<span class="text-danger">*</span></label>
														<input type="text" class="form-control" name="material_id" placeholder="Enter material id" required />
														
													</div>
			<div class="form-group">
														<label>master_id
														<span class="text-danger">*</span></label>
														<input type="text" class="form-control" name="master_id" placeholder="Enter master id" required />
			...
			<div class="form-group">
														...
														<span class="text-danger">*</span></label>
														<input type="text" class="form-control" name="taxable_amount" placeholder="Enter taxable amount" required />
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
			...
			<div class="form-group">
														<label>material_id
														<span class="text-danger">*</span></label>
														<input type="text" class="form-control" id="cat_material_id" name="material_id" placeholder="Enter material id" required />
			...
			<div class="form-group">
														<label>masters_id
														<span class="text-danger">*</span></label>
														<input type="text" class="form-control" id="cat_master_id" name="master_id" placeholder="Enter master id" required />
			...
			<div class="form-group">
														<label>qty
														<span class="text-danger">*</span></label>
														<input type="text" class="form-control" id="cat_qty" name="qty" placeholder="Enter quantity" required />
			...
			<div class="form-group">
														<label>price
														<span class="text-danger">*</span></label>
														<input type="text" class="form-control" id="cat_price" name="price" placeholder="Enter price" required />
			...
			<div class="form-group">
														<label>taxable_amount
														<span class="text-danger">*</span></label>
														<input type="text" class="form-control" id="cat_taxable_amount" name="taxable_amount" placeholder="Enter taxable amount" required />
