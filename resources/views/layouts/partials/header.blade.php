							...
							<div id="kt_header_menu" class="header-menu header-menu-left header-menu-mobile header-menu-layout-default header-menu-root-arrow">
								...
								<ul class="menu-nav">
									...
									<li class="menu-item menu-item-submenu menu-item-rel" >
										<a href="{{url('createbill')}}" class="menu-link ">
										...
										<div class="menu-submenu menu-submenu-classic menu-submenu-left">
											<ul class="menu-subnav">
													...
													<a href="{{url('shop')}}" class="menu-link ">
														...
														<span class="menu-text">Franchise Entries</span>
														<i class="menu-arrow"></i>
													</a>
													...
													<a href="{{url('menus')}}" class="menu-link ">
														...
														<span class="menu-text">Create Shops</span>
														<i class="menu-arrow"></i>
													</a>
												</li> 
</li>
													...
													<a href="{{url('menus')}}" class="menu-link ">
														...
														<span class="menu-text">Display Menus</span>
														<i class="menu-arrow"></i>
													</a>
												</li> 
													<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
									...
									<li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click" aria-haspopup="true">
										...
										<div class="menu-submenu menu-submenu-classic menu-submenu-left">
											<ul class="menu-subnav">
												...
												<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
													<a href="{{url('brandlist')}}" class="menu-link ">
														<span class="svg-icon menu-icon">
															<!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Mail-opened.svg-->
															<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
														...
														<span class="menu-text">Brand Creation</span>
														<i class="menu-arrow"></i>
													</a>
												...
												<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
													<a href="{{url('materials')}}" class="menu-link ">
														...
														<span class="menu-text">Material Creation</span>
														<i class="menu-arrow"></i>
													</a>
